...
test.describe('Targeting Workbench - API Integration Tests', () => {
  ...
  test.describe('Decision Gates Integration', () => {
    test('DecisionGatesBar should fetch and display real API data', async ({ page }) => {
    ...
    test('Decision Gates API should return valid structure', async ({ request }) => {
      ...
      ['roe', 'cde', 'weather', 'deconfliction'].forEach(gate => {
        ...
        expect(['GREEN', 'YELLOW', 'RED']).toContain(data[gate].status);
      });
    });
  });

  test.describe('Target Nomination Board Integration', () => {
    test('DTL should fetch and display entries from API', async ({ page }) => {
      await page.goto('/smartops/targeting-cell-dashboard');
      
      // Wait for TargetNominationBoard to load
      await page.waitForSelector('text=Dynamic Target List', { timeout: 5000 });
      ...
      const dtlSection = page.locator('text=Dynamic Target List').locator('..').locator('..');
      await expect(dtlSection).toBeVisible();
    });

    test('DTL API should return valid entries', async ({ request }) => {
    ...
    test('TST API should return time-sensitive targets', async ({ request }) => {
    ...
    test('F3EAD Pipeline should be visible', async ({ page }) => {
      await page.goto('/smartops/targeting-cell-dashboard');
      
      await page.waitForSelector('text=F3EAD Target Pipeline', { timeout: 5000 });
  ...
  test.describe('Mission Command Overview Integration', () => {
    test('Mission Intent API should return valid data', async ({ request }) => {
    ...
    test('Targeting Guidance API should return valid data', async ({ request }) => {
    ...
    test('Authority Matrix API should return valid data', async ({ request }) => {
    ...
    test('Operational Tempo API should return valid data', async ({ request }) => {
  ...
  test.describe('Intelligence Integration Panel', () => {
    test('Intel Reports API should return valid data', async ({ request }) => {
    ...
    test('Pattern of Life API should return valid data', async ({ request }) => {
  ...
  test.describe('Effects Assessment Dashboard', () => {
    test('BDA Assessments API should return valid data', async ({ request }) => {
      const response = await request.get(`${API_URL}/bda`);
    ...
    test('Re-attack Recommendations API should return valid data', async ({ request }) => {
      const response = await request.get(`${API_URL}/bda/re-attack`);
  ...
  test.describe('Asset Capability Management', () => {
    test('Strike Platforms API should return valid data', async ({ request }) => {
    ...
    test('ISR Platforms API should return valid data', async ({ request }) => {
  ...
  test.describe('Risk Constraints Monitor', () => {
    test('High Risk Targets API should return valid data', async ({ request }) => {
  ...
  test.describe('Alternative Analysis Panel', () => {
    test('Assumptions API should return valid data', async ({ request }) => {
    ...
    test('Bias Alerts API should return valid data', async ({ request }) => {
  ...
  test.describe('Collaborative Workspace', () => {
    test('Decisions API should return valid data', async ({ request }) => {
    ...
    test('Handovers API should return valid data', async ({ request }) => {
  ...
  test.describe('Target Management', () => {
    test('Targets List API should return valid data', async ({ request }) => {
      const response = await request.get(`${API_URL}/targets?limit=10`);
    ...
    test('Target Summary API should return valid data', async ({ request }) => {
  ...
  test.describe('JTB (Joint Targeting Board)', () => {
    test('JTB Sessions API should return valid data', async ({ request }) => {
  ...
  test.describe('Error Handling', () => {
    test('Components should handle API errors gracefully', async ({ page }) => {
      // Intercept API calls and return errors
      await page.route(`${API_URL}/decision-gates`, route => {
    ...
    test('Invalid API responses should not break UI', async ({ page }) => {
      // Intercept with invalid JSON
      await page.route(`${API_URL}/dtl`, route => {
  ...
  test.describe('Auto-Refresh Functionality', () => {
    test('DecisionGatesBar should auto-refresh', async ({ page }) => {
      let apiCallCount = 0;
