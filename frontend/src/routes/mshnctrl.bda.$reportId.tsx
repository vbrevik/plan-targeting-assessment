...
import { BDAReportHistory } from '@/features/bda/BDAReportHistory';
import { BDAComponentAssessment } from '@/features/bda/BDAComponentAssessment';
import { BDAPeerReview } from '@/features/bda/BDAPeerReview';
import { BDAVersionComparison } from '@/features/bda/BDAVersionComparison';
import { BDAReportGenerator } from '@/features/bda/BDAReportGenerator';
import { BDADistributionManager } from '@/features/bda/BDADistributionManager';

export const Route = createFileRoute('/mshnctrl/bda/$reportId')({
    component: BDADetailPage
});

function BDADetailPage() {
    const { reportId } = useParams({ from: '/mshnctrl/bda/$reportId' });
