// Risk & Constraints Detail Page

import { createFileRoute } from '@tanstack/react-router';
import { RiskConstraintsMonitor } from '@/features/smartops/components/RiskConstraintsMonitor';
...
export const Route = createFileRoute('/smartops/targeting/risk')({
          ...
          <div className="flex items-center gap-3 sm:gap-4 flex-1 min-w-0">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-xs sm:text-sm text-slate-400 mt-1">
                High-Risk Targets • Fratricide Risk • Legal Review • Proportionality Assessment
              </p>
            </div>
          </div>
