// Effects Assessment Detail Page

import { createFileRoute } from '@tanstack/react-router';
import { EffectsAssessmentDashboard } from '@/features/smartops/components/EffectsAssessmentDashboard';
...
export const Route = createFileRoute('/smartops/targeting/effects')({
  component: EffectsDetailPage,
});

function EffectsDetailPage() {
  return (
          ...
          <div className="flex items-center gap-3 sm:gap-4 flex-1 min-w-0">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-xs sm:text-sm text-slate-400 mt-1">
                Battle Damage Assessment • Re-attack Recommendations • Strike Effectiveness
              </p>
            </div>
          </div>
