// Alternative Analysis Detail Page

import { createFileRoute } from '@tanstack/react-router';
import { AlternativeAnalysisPanel } from '@/features/smartops/components/AlternativeAnalysisPanel';
...
export const Route = createFileRoute('/smartops/targeting/analysis')({
          ...
          <div className="flex items-center gap-3 sm:gap-4 flex-1 min-w-0">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-xs sm:text-sm text-slate-400 mt-1">
                Assumptions • Bias Alerts • Alternative Hypotheses • Challenge Analysis
              </p>
            </div>
          </div>
