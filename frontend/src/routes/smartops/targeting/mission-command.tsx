// Mission Command Detail Page

import { createFileRoute } from '@tanstack/react-router';
import { MissionCommandOverview } from '@/features/smartops/components/MissionCommandOverview';
...
export const Route = createFileRoute('/smartops/targeting/mission-command')({
  component: MissionCommandDetailPage,
});

function MissionCommandDetailPage() {
  return (
          ...
          <div className="flex items-center gap-3 sm:gap-4 flex-1 min-w-0">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-xs sm:text-sm text-slate-400 mt-1">
                Commander's Intent • Targeting Guidance • Authority Matrix • Operational Tempo
              </p>
            </div>
          </div>
