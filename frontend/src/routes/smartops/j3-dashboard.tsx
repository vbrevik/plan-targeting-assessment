                    ...
                    <div className="space-y-6">
                        ...
                        <div className="bg-slate-900 border border-slate-800 rounded-lg">
                            ...
                            <div className="p-6 space-y-2">
                                {canSubmit && <QuickActionButton icon={Send} label="Submit Proposal" to="/smartops/proposals" editable />}
                                {canSubmit && <QuickActionButton icon={FileText} label="Create RFI" to="/smartops/rfis" editable />}
                                {canEdit && <QuickActionButton icon={Calendar} label="Update Battle Rhythm" to="/smartops/battle-rhythm" editable />}
                                <QuickActionButton icon={Calendar} label="View Battle Rhythm" to="/smartops/battle-rhythm" />
                                <QuickActionButton icon={Radio} label="Combat Net Radio" to="/smartops/cnr" />
                                <QuickActionButton icon={Crosshair} label="Targeting Board" to="/smartops/targeting" />
                            </div>
                        </div>
                    </div>
                </div>
