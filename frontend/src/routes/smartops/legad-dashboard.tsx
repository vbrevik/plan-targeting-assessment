...
export const Route = createFileRoute('/smartops/legad-dashboard')({
                    ...
                    <div className="space-y-6">
                        <div className="bg-slate-900 border border-slate-800 rounded-lg">
                            ...
                            <div className="p-6 space-y-2">
                                <QuickActionButton icon={Scale} label="Advisory Queue" to="/smartops/advisory" />
                                <QuickActionButton icon={Shield} label="ROE Manager" to="/smartops/roe" />
                                <QuickActionButton icon={Target} label="Targeting Review" to="/smartops/targeting" />
                            </div>
                        </div>
                    </div>
                </div>
