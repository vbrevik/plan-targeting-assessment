...
import { OPLANBuilder } from '@/features/smartops/components/OPLANBuilder'
import { OPLANViewer } from '@/features/smartops/components/OPLANViewer'
import { PenTool, Eye } from 'lucide-react'
import { cn } from '@/lib/utils'

export const Route = createLazyFileRoute('/smartops/oplan')({
