...
export const Route = createFileRoute('/smartops/j4-dashboard')({
                    ...
                    <div className="space-y-6">
                        <div className="bg-slate-900 border border-slate-800 rounded-lg">
                            ...
                            <div className="p-6 space-y-2">
                                <QuickActionButton icon={Package} label="Request Resupply" to="/smartops/logistics" />
                                <QuickActionButton icon={Network} label="Supply Chain" to="/smartops/supply-chain" />
                                <QuickActionButton icon={Factory} label="Infrastructure" to="/smartops/infrastructure" />
                            </div>
                        </div>
                    </div>
                </div>
