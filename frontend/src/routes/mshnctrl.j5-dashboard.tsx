                    ...
                    <div className="space-y-6">
                        ...
                        <div className="bg-slate-900 border border-slate-800 rounded-lg">
                            ...
                            <div className="p-6 space-y-2">
                                {canEditAssumptions && (
                                    <QuickActionButton icon={Shield} label="Manage Assumptions" to="/mshnctrl/assumptions" editable />
                                )}
                                {!canEditAssumptions && (
                                    <QuickActionButton icon={Shield} label="Review Assumptions" to="/mshnctrl/assumptions" />
                                )}
                                {canEditPlans && (
                                    <>
                                        <QuickActionButton icon={ScrollText} label="Edit OPLANs" to="/mshnctrl/oplan" editable />
                                        <QuickActionButton icon={Map} label="Update Campaign" to="/mshnctrl/campaign" editable />
                                        <QuickActionButton icon={Compass} label="Edit CONOPS" to="/mshnctrl/conops" editable />
                                    </>
                                )}
                                {!canEditPlans && (
                                    <>
                                        <QuickActionButton icon={ScrollText} label="View OPLANs" to="/mshnctrl/oplan" />
                                        <QuickActionButton icon={Map} label="View Campaign" to="/mshnctrl/campaign" />
                                    </>
                                )}
                                <QuickActionButton icon={Divide} label="CoA Wargamer" to="/mshnctrl/coa-wargamer" />
                                <QuickActionButton icon={Flag} label="Strategic Direction" to="/mshnctrl/strategic-direction" />
                            </div>
                        </div>
                    </div>
                </div>
