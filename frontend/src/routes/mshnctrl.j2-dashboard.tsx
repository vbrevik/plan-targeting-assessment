...
export const Route = createFileRoute('/mshnctrl/j2-dashboard')({
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="bg-slate-900 border border-slate-800 rounded-lg">
                            ...
                            <div className="p-6 space-y-2">
                                {canEdit && (
                                    <>
                                        <QuickActionButton icon={FileText} label="Submit Assessment" to="/mshnctrl/rfis" editable />
                                        <QuickActionButton icon={Activity} label="Update Intelligence" to="/mshnctrl/uncertainty" editable />
                                    </>
                                )}
                                <QuickActionButton icon={Search} label="Uncertainty Analysis" to="/mshnctrl/uncertainty" />
                                <QuickActionButton icon={Globe} label="Digital Twin" to="/mshnctrl/digital-twin" />
                                <QuickActionButton icon={Radio} label="Sensor Triage" to="/mshnctrl/triage" />
                                <QuickActionButton icon={Target} label="RXP Overview" to="/mshnctrl/rxp" />
                                <QuickActionButton icon={Eye} label="Social Domain" to="/mshnctrl/social-domain" />
                            </div>
                        </div>
                    </div>
                </div>
