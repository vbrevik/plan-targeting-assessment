...
import { DecisionGatesBarCompact } from '@/features/decisions/DecisionGatesBar';
import { DashboardCustomizer } from '@/features/shared/DashboardCustomizer';
import { UpdateNotification } from '@/features/admin/UpdateNotification';
import { SecurityBadge, SecurityBanner } from '@/components/SecurityBadge';
import { useTargetingPreferences } from '@/features/targeting/hooks/useTargetingPreferences';
import { CompactMetricsBar } from '@/features/shared/CompactMetricsBar';
import { F3EADHorizontalFunnel } from '@/features/targeting/F3EADHorizontalFunnel';
import { TargetMasterList } from '@/features/targeting/TargetMasterList';
import { TargetDetailView } from '@/features/targeting/TargetDetailView';
import { targetingApi } from '@/lib/mshnctrl/api/targeting.api';
import { DashboardModeSwitcher } from '@/features/shared/DashboardModeSwitcher';
import { DashboardMode } from '@/features/shared/types/dashboard';
import { COPSummary } from '@/features/operations/COPSummary';
import { AssetCapabilityManagement } from '@/features/logistics/AssetCapabilityManagement';
import { StrikeOptimizer } from '@/features/targeting/StrikeOptimizer';
import { TimeFilter } from '@/features/shared/TimeFilter';
import type { TimeWindow } from '@/features/shared/TimeFilter';
import { CyberOperationsCockpit } from '@/features/operations/CyberOperationsCockpit';

export const Route = createFileRoute('/mshnctrl/targeting-cell-dashboard')({
