...
export const Route = createFileRoute('/smartops/analyst-dashboard')({
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="bg-slate-900 border border-slate-800 rounded-lg">
                            ...
                            <div className="p-6 space-y-2">
                                <QuickActionButton icon={FileText} label="Submit Report" to="/smartops/rfis" />
                                <QuickActionButton icon={Target} label="Update Track" to="/smartops/rxp" />
                                <QuickActionButton icon={Globe} label="View COP" to="/smartops/cop-summary" />
                                <QuickActionButton icon={Users} label="View ORBAT" to="/smartops/orbat" />
                            </div>
                        </div>
                    </div>
                </div>
