// Assets & Capabilities Detail Page
...
export const Route = createFileRoute('/smartops/targeting/assets')({
  component: AssetsDetailPage,
});

function AssetsDetailPage() {
  return (
          ...
          <div className="flex items-center gap-3 sm:gap-4 flex-1 min-w-0">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-xs sm:text-sm text-slate-400 mt-1">
                Strike Platforms • ISR Platforms • Munitions Inventory • Asset Pairing
              </p>
            </div>
          </div>
