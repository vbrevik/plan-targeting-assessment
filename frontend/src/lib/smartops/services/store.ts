...
class MockDataStore {
    ...
    briefs: Brief[] = [
        {
            id: 'b-training-01',
            title: 'System Orientation: SmartOps Workflow',
            description: 'Introduction to Joint Targeting and Logistics synchronization.',
            ownerCell: 'IM-Cell',
            bluf: 'SmartOps leverages a data-driven Ontology Layer to synchronize Targeting, Logistics, and ROE. Successful engagement requires all three nodes to be Released/Nominal.',
            status: 'Final',
