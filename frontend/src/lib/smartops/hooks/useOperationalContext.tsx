...
import type { OperationalContext, OperationPhase } from '@/lib/smartops/types';
...
const STORAGE_KEY = 'smartops_operational_context';
...
export function OperationalContextProvider({ children }: { children: ReactNode }) {
    ...
    useEffect(() => {
        const initialize = async () => {
            ...
            try {
                const { SmartOpsService } = await import('@/lib/smartops/mock-service');
